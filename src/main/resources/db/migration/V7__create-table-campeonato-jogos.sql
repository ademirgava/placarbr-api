CREATE TABLE campeonato_jogos (
	...
	equipe_mandante_id BIGINT NOT NULL,
	equipe_visitante_id BIGINT NOT NULL,
...
ALTER TABLE campeonato_jogos ADD CONSTRAINT campeonato_jogos_fk2 FOREIGN KEY (equipe_mandante_id) REFERENCES equipes(id);

ALTER TABLE campeonato_jogos ADD CONSTRAINT campeonato_jogos_fk3 FOREIGN KEY (equipe_visitante_id) REFERENCES equipes(id);
