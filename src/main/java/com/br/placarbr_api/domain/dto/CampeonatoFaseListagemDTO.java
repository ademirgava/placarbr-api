...
public record CampeonatoFaseListagemDTO(Long id, String nome,String descricao,TipoFase fase,Integer classificados, Integer quantidadeGrupos, Integer quantidadeTimes, Boolean idaVolta, Integer ordemFase, List<EquipeListagemDTO> equipes) {
