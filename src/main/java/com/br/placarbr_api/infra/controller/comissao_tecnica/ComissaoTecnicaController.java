...
import com.br.placarbr_api.infra.controller.comissao_tecnica.dto.ComissaoTecnicaDetalheDTO;
import com.br.placarbr_api.infra.controller.comissao_tecnica.dto.ComissaoTecnicaListagemDTO;
...
public class ComissaoTecnicaController {
	...
	private final AtualizarComissaoTecnica atualizarComissaoTecnica;

	public ComissaoTecnicaController(CriarComissaoTecnica criarComissaoTecnica, ComissaoTecnicaMapper mapper, BuscarPorIdComissaoTecnica buscarPorIdComissaoTecnica, ListarTodoComissaoTecnica listarTodoComissaoTecnica, AtualizarComissaoTecnica atualizarComissaoTecnica) {
		...
		this.atualizarComissaoTecnica = atualizarComissaoTecnica;
	}
	...
	public ResponseEntity<ComissaoTecnicaDetalheDTO> atualizar(@RequestBody @Valid ComissaoTecnicaAtualizaDTO dto) {
		return ResponseEntity.ok(new ComissaoTecnicaDetalheDTO(atualizarComissaoTecnica.atualizar(mapper.toDomain(dto))));
	}
}
